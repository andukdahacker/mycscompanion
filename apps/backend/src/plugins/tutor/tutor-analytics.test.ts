  ...
  it('should support filtering by model', async () => {
    await db
      ...
      .values([
        ...
        { id: generateId(), session_id: sessionId, user_id: TEST_UID, role: 'assistant', content: 'Sonnet response', model: 'claude-sonnet-4-6' },
  ...
  it('should count model usage correctly', async () => {
    await db
      ...
      .values([
        ...
        { id: generateId(), session_id: sessionId, user_id: TEST_UID, role: 'assistant', content: 'A2', model: 'claude-sonnet-4-6' },
